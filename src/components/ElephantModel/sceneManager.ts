...
const renderer = new WebGLRenderer({antialias:true, alpha: true, toneMapping: ACESFilmicToneMapping });
...
const camera = new PerspectiveCamera(80 - ( window.innerWidth /  2000) * 30, window.innerWidth / window.innerHeight);
